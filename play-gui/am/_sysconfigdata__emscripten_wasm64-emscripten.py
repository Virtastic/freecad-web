...
# Generated by CPython 3.13 (PSF licence); not authored here. See below.
# The sysconfig data CPython generated when it was built for this port (emscripten,
# wasm64, the emscripten-mt configuration the link uses). CPython writes it into the
# BUILD tree (build/lib.emscripten-wasm64-3.13/), and the link preloads the stdlib
# from the SOURCE tree (deps/src/cpython/Lib), so the image never had it and
# sysconfig.get_config_vars() raised ModuleNotFoundError -- which took `import
# zoneinfo` (via _tzpath) and with it tzlocal and the Lens add-on down at startup
# (measured 2026-09-22). The page writes it into site-packages in preRun, next to
# sitecustomize.py. The build root has been rewritten to /build; nothing else is
# edited.
...
build_time_vars = {
    ...
    'AR': '/build/emsdk/upstream/emscripten/emar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': '/build/emsdk/upstream/emscripten/emcc -shared -sMEMORY64=1',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.js',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/build/emsdk/upstream/emscripten/emcc',
    'CCSHARED': '',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1',
    'CFLAGSFORSHARED': '',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-sMEMORY64=1',
    'CONFIGURE_LDFLAGS_NODIST': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js -sALLOW_MEMORY_GROWTH -sNODERAWFS',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'-C' '--disable-test-modules' '--host=wasm64-unknown-emscripten' '--build=x86_64-pc-linux-gnu' '--with-emscripten-target=node' '--with-build-python=/build/deps/src/cpython/builddir/build/python' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm64-unknown-emscripten' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/build/emsdk/upstream/emscripten/cache/sysroot/local/lib/pkgconfig:/build/emsdk/upstream/emscripten/cache/sysroot/lib/pkgconfig' 'CC=/build/emsdk/upstream/emscripten/emcc'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/build/deps/src/cpython/builddir/emscripten-mt/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/build/deps/src/cpython/builddir/emscripten-mt/lcov-report',
    ...
    'CXX': '/build/emsdk/upstream/emscripten/em++',
    ...
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-313-wasm64-emscripten.so',
    'FILEMODE': 644,
    'FREEZE_MODULE': '/build/deps/src/cpython/builddir/build/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/build/deps/src/cpython/builddir/build/python ../../Programs/_freeze_module.py',
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '/build/emsdk/node/24.19.0_64bit/bin/node --experimental-wasm-memory64',
    'HOST_GNU_TYPE': 'wasm64-unknown-emscripten',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/build/emsdk/upstream/emscripten/emcc -shared -sMEMORY64=1',
    'LDFLAGS': '-sMEMORY64=1',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/build/emsdk/upstream/emscripten/emcc -shared -sMEMORY64=1',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.13',
    'LIBDIR': '/usr/local/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I../../Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/usr/local/lib/pkgconfig',
    'LIBPL': '/usr/local/lib/python3.13/config-3.13-wasm64-emscripten',
    'LIBPYTHON': '',
    ...
    'LIBS': '-ldl  -lpthread',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/build/emsdk/upstream/emscripten/emcc',
    'LINKFORSHARED': '-sEXIT_RUNTIME -O2 -g0',
    ...
    'LLVM_PROF_MERGER': '',
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -sUSE_ZLIB -sUSE_BZIP2 -sUSE_ZLIB    Modules/_hacl/libHacl_Hash_SHA2.a   -lm Modules/expat/libexpat.a',
    'MACHDEP': 'emscripten',
    'MACHDEP_OBJS': '',
    ...
    'MULTIARCH': 'wasm64-emscripten',
    'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"wasm64-emscripten\\"',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='/build/emsdk/node/24.19.0_64bit/bin/node --experimental-wasm-memory64' _PYTHON_PROJECT_BASE=/build/deps/src/cpython/builddir/emscripten-mt _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm64-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/deps/src/cpython/builddir/emscripten-mt/`cat pybuilddir.txt`) /build/deps/src/cpython/builddir/build/python",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/build/deps/src/cpython/builddir/build/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-sMEMORY64=1 -sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js -sALLOW_MEMORY_GROWTH -sNODERAWFS',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-sMEMORY64=1',
    'PY_LDFLAGS_NODIST': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js -sALLOW_MEMORY_GROWTH -sNODERAWFS',
    'PY_LDFLAGS_NOLTO': '-sMEMORY64=1',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 0,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -sMEMORY64=1 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-313-wasm64-emscripten',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='/build/emsdk/node/24.19.0_64bit/bin/node --experimental-wasm-memory64' _PYTHON_PROJECT_BASE=/build/deps/src/cpython/builddir/emscripten-mt _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm64-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/deps/src/cpython/builddir/emscripten-mt/`cat pybuilddir.txt`) /build/deps/src/cpython/builddir/build/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='/build/emsdk/node/24.19.0_64bit/bin/node --experimental-wasm-memory64' _PYTHON_PROJECT_BASE=/build/deps/src/cpython/builddir/emscripten-mt _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm64-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/deps/src/cpython/builddir/emscripten-mt/`cat pybuilddir.txt`) /build/deps/src/cpython/builddir/build/python -m test",
    ...
    'abs_builddir': '/build/deps/src/cpython/builddir/emscripten-mt',
    'abs_srcdir': '/build/deps/src/cpython/builddir/emscripten-mt/../..',
