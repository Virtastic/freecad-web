...
emcmake cmake -S deps/src/coin3d -B build-coin -G Ninja \
  ...
  -DCMAKE_CXX_FLAGS="-fwasm-exceptions -pthread -O2 -DGLES_SILENCE_DEPRECATION -include $DW/include/gl_compat.h" \
  -DCMAKE_C_FLAGS="-fwasm-exceptions -pthread -O2 -include $DW/include/gl_compat.h" \
