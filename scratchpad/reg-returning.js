...
(async()=>{
 ...
 const b=await puppeteer.launch({executablePath:CHROME,headless:false,defaultViewport:null,args:['--no-sandbox','--use-gl=angle','--use-angle=metal','--enable-features=SharedArrayBuffer','--window-size=1400,900'],protocolTimeout:1200000,userDataDir:'/tmp/fc-returning'});
 ...
 await p.goto('http://localhost:8793/index.html',{waitUntil:'domcontentloaded',timeout:200000});
